...
sudo -u splunk /data/splunk/splunk/bin/splunk edit cluster-config -mode master -replication_factor ${ixrcrepf} -search_factor ${ixrcsf} -auth admin:${splunkadminpass}
service splunk restart
