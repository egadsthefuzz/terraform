...
variable "splunkindexer_clusterrepport" {}
variable "indexer_clustermembercount" {}
variable "splunk_indexer_cluster_volume_size" {}
variable "splunk_indexer_cluster_root_volume_size" {}
variable "indexer_clusterkey" {}
variable "indexer_clusterrepf" {}
variable "indexer_clustersf" {}
variable "indexer_clusterlabel" {}
